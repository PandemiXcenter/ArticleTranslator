...
1. Ordinary translated text
   ...
   block may continue onto the next page. Confirm an incoming continuation from
   current wording and preceding-page context, return only the current-page
   fragment, and set `classification_review_required=true` when the relationship
